report 50099 "Job Revenue Recognition"
{
    ...
    begin
        ...
        //GenJournalLine.VALIDATE("Bal. Account No.", GeneralPostingSetup."Sales Account");      //Hexagon Changes DNVP
        GenJournalLine.VALIDATE("Bal. Account No.", GeneralPostingSetup."IFRS15 Sales Account");      //Mexico Changes DNVP
