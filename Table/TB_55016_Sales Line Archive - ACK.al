OBJECT Table 55016 Sales Line Archive - ACK
{
  OBJECT-PROPERTIES
  {
    Date=04/06/20;
  ...
  PROPERTIES
  {
    ...
    CaptionML=ENU=Sales Line Archive - ACK;
    PasteIsValid=No;
  }
  FIELDS
  {
    ...
    { 3   ;   ;Document No.        ;Code20        ;TableRelation="Sales Header Archive - ACK".No. WHERE (Document Type=FIELD(Document Type),
