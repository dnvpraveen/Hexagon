...
OBJECT Codeunit 55000 Update Job Records
{
  OBJECT-PROPERTIES
  {
    Date=21-07-20;
  ...
  {
    VAR
      OriginalOrderNo@1000000000 : Text[35];

    PROCEDURE UpdateRecords@1000000000(Job@1000000000 : Record 167);
    VAR
      JobRecordsforSmax@1000000001 : Record 55000;
      JobRecordsforSmax2@1000000005 : Record 55000;
      JobTask@1000000002 : Record 1001;
      JobPlanningLine@1000000003 : Record 1003;
    ...
    PROCEDURE UpdateShipmentDetails@1000000001(SalesShipmentHeader@1000000000 : Record 110);
    VAR
      JobRecordsforSmax@1000000001 : Record 55000;
      JobRecordsforSmax2@1000000002 : Record 55000;
    BEGIN
    ...
    PROCEDURE UpdateInvoiceDetails@1000000003(SalesInvoiceHeader@1000000000 : Record 112);
    VAR
      JobRecordsforSmax@1000000001 : Record 55000;
      JobRecordsforSmax2@1000000002 : Record 55000;
      OrderLogDetails@1000000003 : Record 55006;
    BEGIN
      JobRecordsforSmax.RESET;
    ...
    PROCEDURE UpdateSerialNo@1000000002(JobLedgerEntry@1000000000 : Record 169);
    VAR
      JobRecordsforSmax@1000000001 : Record 55000;
      JobRecordsforSmax2@1000000002 : Record 55000;
    BEGIN
    ...
    PROCEDURE UpdateBillingInvoiceDetails@1(LSalesInvoiceHeader@1000 : Record 112;LSalesInvoiceLine@1001 : Record 113);
    VAR
      SalesInvoiceHeader_ACk@1002 : Record 55012;
      SalesInvoiceLine_Ack@1003 : Record 55013;
    BEGIN
