codeunit 55009 "Compare Records"
{
    ...
    PROCEDURE ComparePurchaseRecord(VAR "PONo.": Code[20]): Boolean;
    VAR
        FldRef1: FieldRef;
        FldRef2: FieldRef;
        PurchaseHead1: Record 38;
        PurchHeadArch1: Record 5109;
        i: Integer;
        Flag: Boolean;
        ArchiveManagement: Codeunit 5063;
        PurchaseHead: RecordRef;
        PurchaseHeadArch: RecordRef;
        PurchaseLine: RecordRef;
        PurchaseLineArchive: RecordRef;
        PurchaseLine1: Record 39;
        PurchaseLineArchive1: Record 5110;
        j: Integer;
        FldRef3: FieldRef;
        FldRef4: FieldRef;
        Flag1: Boolean;
    ...
    BEGIN
        ...
        IF Flag OR Flag1 THEN
            ...
            ArchiveManagement.StorePurchDocument(PurchaseHead1, false)
        ELSE
            MESSAGE('Document is unchanged..... document will not be archived...');
    END;

    PROCEDURE CompareSalesRecord(VAR "SONo.": Code[20]): Boolean;
    VAR
        FldRef1: FieldRef;
        FldRef2: FieldRef;
        SalesHead1: Record 36;
        SalesHeadArch1: Record 5107;
        i: Integer;
        Flag: Boolean;
        ArchiveManagement: Codeunit 5063;
        SalesHead: RecordRef;
        SalesHeadArch: RecordRef;
        SalesLine: RecordRef;
        SalesLineArchive: RecordRef;
        SalesLine1: Record 37;
        SalesLineArchive1: Record 5108;
        j: Integer;
        FldRef3: FieldRef;
        FldRef4: FieldRef;
        Flag1: Boolean;
    ...
    BEGIN
        ...
        IF Flag OR Flag1 THEN
            //ArchiveManagement.ArchiveSalesDocumentdirect(SalesHead1) old code
            ArchiveManagement.StoreSalesDocument(SalesHead1, false)
        ELSE
            MESSAGE('Document is unchanged..... document will not be archived...');
    END;
